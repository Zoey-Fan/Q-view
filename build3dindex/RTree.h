...
protected:
  ...
  ///Define a segment within 3 dimensional.
  struct Seg3d
  {
    ELEMTYPE s_start[3];                      
    ELEMTYPE s_end[3];                      
  ...
  bool Overlap3d(Seg3d* s_segA, Rect* a_rectB) const;
  inline bool OverlapSegRect2d(ELEMTYPE x1,ELEMTYPE y1,ELEMTYPE x2,ELEMTYPE y2,ELEMTYPE minx,ELEMTYPE miny,ELEMTYPE maxx,ELEMTYPE maxy) const;
  inline bool OverlapSeg2d(ELEMTYPE x1,ELEMTYPE y1,ELEMTYPE x2,ELEMTYPE y2,ELEMTYPE tx1,ELEMTYPE ty1,ELEMTYPE tx2,ELEMTYPE ty2) const;
...
public:
  // return all the AABBs that form the 3D R-Tree
